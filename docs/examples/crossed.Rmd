...
See the [introduction](index.html) for an overview. Also see [other analyses](../mixchange/abrasion.html) of this data.
See the textbook for a full discussion. See a [STAN analysis](../stan/crossed.html) of the same data.
...
```{r plotsds}
ddf <- data.frame(rbind(sigmarun,sigmapos,sigmaepsilon),errterm=gl(3,1024,labels = c("run","position","epsilon")))
